...
- Generación de imágenes (`ImageGeneratorPort` + adaptador Pollinations/Cloudflare Workers AI, GDD §6-§7.3) sigue sin construir. Más campañas curadas/híbridas más allá de las dos actuales, también pendiente.
